                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            ...
                            you are reviewing a OCR-ed page, you also still need
                            to review.
                        </p>
                        ...
                        <p>
                            ...
                            and{' '}
                            <a href="/acount/login/?next={{ request.path }}">
                                log in
                            </a>{' '}
                            to use this feature.
                        </p>
                        <h6>
                            Why does{' '}
                            <span class="fst-italic">By the People</span> have
                            this feature?
                        </h6>
                        <p>
                            ...
                            point for some typed pages. Use it if it if you like
                            it or skip it if you don’t!
                        </p>
                    </div>
