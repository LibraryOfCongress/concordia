...
class ImporterTasksTest(TestCase):
    ...
    def test_get_request_data(self):
        ...
        self.assertIn(response['resources']['url'], 'https://www.loc.gov/item/mss85943')
    ...
    def test_get_collection_pages(self):
        ...
        self.assertIn(response, self.valid_collection_test_data['no_of_pages'])
    ...
    def test_get_collection_pages_for_invalid_collection(self):
        ...
        self.assertEqual(int, type(response))
        self.assertIn(response, self.invalid_collection_test_data['no_of_pages'])

    def test_get_collection_params_without_fa(self):
        curl, cparams = get_collection_params(self.valid_collection_test_data['url'])
        self.assertEqual(curl, self.valid_collection_test_data['url'])
    ...
    def test_get_collection_params_with_fa(self):
        ...
        self.assertEqual(curl, test_url)
