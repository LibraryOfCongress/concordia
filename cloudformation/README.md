...
10. Deploy a bastion host - use `infrastructure/bastion_host.yaml` CF template
    ...
    1. Run the image: `sudo docker run -e ENV_NAME=prod -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY -e AWS=1 $AWS_ACCOUNT_ID.dkr.ecr.us-east-1.amazonaws.com/concordia`
