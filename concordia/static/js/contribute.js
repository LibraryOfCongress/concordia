...
(function($) {
   ...
   */
    function TagsInput(element, options) {
        ...
        this.$container = $(
            '<div class="tag-input bg-offwhite shadow-regular pxy-quarter rounded"></div>'
        );
        this.$input = $(
            '<input type="text" class="bg-offwhite px-quarter shadow-regular rounded typeahead" placeholder="' +
     ...
     */
        add: function(item, dontPushVal, options) {
            ...
            // add a tag element
            var $tag = $(
                '<span class="pxy-quarter ' +
                    htmlEncode(tagClass) +
                    (itemTitle !== null ? '" title="' + itemTitle : '') +
                    '">' +
                    htmlEncode(itemText) +
                    '<span class="ml-quarter" data-role="remove">&times</span></span>'
            );
            $tag.data('item', item);
            ...
            if (
                ...
                self.$container.addClass('tag-input-max');
     ...
     */
        remove: function(item, dontPushVal, options) {
            ...
            if (self.options.maxTags > self.itemsArray.length)
                self.$container.removeClass('tag-input-max');
