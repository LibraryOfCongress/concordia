...
urlpatterns = [
    ...
    path("help-center/welcome-guide-esp/", views.simple_page, name="welcome-guide-spanish"),
    path("help-center/how-to-transcribe-esp/", views.simple_page, name="how-to-transcribe-spanish"),
    path("help-center/how-to-review-esp/", views.simple_page, name="how-to-review-spanish"),
